...
const AddFlight = () => {
  ...
  return (
    <div>
      <h1 className="text-center">ADD FLIGHT</h1>
          ...
          <div className="col-12">
            <div className="row">
              ...
              <div className="col-md-6">
                ...
                <select className="form-select" name="status" value={input.status} onChange={inputHandler}>
              ...
              <div className="col-12">
                <button className="btn btn-primary mt-3" onClick={readValue}>Add Flight</button>
              </div>
            </div>
          </div>
        </div>
